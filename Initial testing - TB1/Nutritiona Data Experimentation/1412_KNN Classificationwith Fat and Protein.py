...
# ## Using sklearn with KNN algorithm to extract classification of foods ('Beans and Lentils','Fish','Vegetables') based on fat and protein contents of certain types of food. 
...
data_FBL = data_clean[data_clean['Food Group'].isin(['Beans and Lentils','Fish','Vegetables'])]
data_FBL
...
for weights in ['uniform', 'distance']:
    ...
    # baked goods is veg, fish is dark blue and beans and lentils is light blue 
